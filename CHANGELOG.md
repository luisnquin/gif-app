* 65912bb - (HEAD -> master, origin/master) feat: request verification before query in Login handler, new handlers highly related with crimes and models (hace 7 minutos) <Luis Quiñones Requelme>
